...
@section('titulo',"Crear un nuevo registro")
@section("botonera")
<a href="{{ route('proyectos.index') }}" class="btn btn-success">Regresar a Entradas</a>
@endsection
...
<form action="{{ route('proyectos.store') }}" method="POST">
    ...
    <div class="mb-3">
        <label for="descripcion" class="form-label">Hora y Fecha</label>
